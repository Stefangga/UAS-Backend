...
<div class="d-flex">
    ...
    <div class="bg-dark text-white p-3 vh-100" style="width: 250px;">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo base_url('mahasiswa') ?>">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo base_url('mahasiswa/rekapnilaimahasiswa') ?>">
    ...
    <p>Halo, Mahasiswa! Anda berhasil login.</p>
    <p>Ini adalah halaman utama dashboard Anda. Dari sini, Anda bisa melihat nilai anda.</p>
</div>
        </div>
    </div>
</div>
