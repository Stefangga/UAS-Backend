...
<head>
    ...
    <style>
        /* Tambahkan warna latar belakang untuk area luar kotak */
        body {
            background-color: #f0f8ff; /* Ganti dengan warna yang Anda inginkan */
        }
        .card {
...
<div class="d-flex">
    ...
    <div class="bg-dark text-white p-3 vh-100" style="width: 250px;">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo base_url('dosen') ?>">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo base_url('dosen/editnilaimahasiswa') ?>">
    ...
    <p>Halo, Dosen! Anda berhasil login ke dalam sistem.</p>
    <p>Ini adalah halaman utama dashboard Anda. Dari sini, Anda bisa mengelola nilai Mahasiswa.</p>
</div>
        </div>
    </div>
</div>
